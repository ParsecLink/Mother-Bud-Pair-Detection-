...
This directory contains compact returned annotations and rule-comparison tables for Groups 4 and 5. These results are research artifacts, not accepted ground truth or final accuracy measurements.
